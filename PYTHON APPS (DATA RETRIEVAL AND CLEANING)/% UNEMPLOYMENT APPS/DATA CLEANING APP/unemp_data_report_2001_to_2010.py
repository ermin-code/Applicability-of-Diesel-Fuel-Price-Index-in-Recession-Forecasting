...
with open('./RAW DATA/% Unemployment/Data File/unemp_data_report_2001_to_2010.json') as json_file:
...
df_merge1.to_csv('./CLEAN DATA/% Unemployment/Data File/clean_unemp_data_report_2001_to_2010.csv')
