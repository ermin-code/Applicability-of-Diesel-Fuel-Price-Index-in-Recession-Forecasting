...
with open('./RAW DATA/Consumer Price Index (CPI)/Data File/cpi_data_report_2001_to_2010.json') as json_file:
...
df_merge1.to_csv('./CLEAN DATA/Consumer Price Index (CPI)/Data File/clean_cpi_data_report_2001_to_2010.csv')
